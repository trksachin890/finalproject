...
(function($) {
    ...
    $(".offcanvas-close, .offcanvas-overlay").on("click", function(event) {
        event.preventDefault();
    ...
    // Handle sub-menu toggle in offcanvas menu
    var $offcanvasMenu = $(".offcanvas-menu, .overlay-menu");
    $offcanvasMenu.find(".sub-menu").parent().prepend('<span class="menu-expand"></span>');

    $offcanvasMenu.on("click", "li a, .menu-expand", function(event) {
        var $this = $(this);
        if ($this.attr("href") === "#" || $this.hasClass("menu-expand")) {
            event.preventDefault();
            var $siblingsMenu = $this.siblings("ul:visible");

            if ($siblingsMenu.length) {
                // Close the visible submenu
    ...
    // Additional Swiper sliders for product and gallery
    ...
    var $quantityInput = $(".cart-plus-minus");
    $quantityInput.prepend('<div class="dec qtybutton">-</div>');
    $quantityInput.append('<div class="inc qtybutton">+</div>');
    ...
    $("[data-countdown]").each(function() {
        ...
        $this.countdown(countdownDate, function(event) {
            $this.html(event.strftime(
                '<span class="cdown hour"><span class="cdown-1">%-H</span><p>Hrs</p></span>' +
                '<span class="cdown minutes"><span class="cdown-1">%M</span><p>Min</p></span>' +
                '<span class="cdown second"><span class="cdown-1">%S</span><p>Sec</p></span>'
            ));
        });
    });

    // Blog post media slider
